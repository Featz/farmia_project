...
def run_kafka_raw_to_bronze():
    """
    Punto de entrada para ejecutar la promoción de datos desde la capa Raw a Bronze.
    Este script está específicamente diseñado para procesar el dataset de telemetría de sensores.
    """
    print("======================================================================")
    print("INICIANDO SCRIPT: RAW -> BRONZE (SENSOR TELEMETRY)")
    print("======================================================================")
    ...
    try:
        ...
        print("======================================================================")
        print("SCRIPT: RAW -> BRONZE FINALIZADO EXITOSAMENTE")
        print("======================================================================")
        
    except Exception as e:
        print("======================================================================")
        print("ERROR EN LA EJECUCIÓN DEL SCRIPT: RAW -> BRONZE")
        print("======================================================================")
        print(f"Error: {str(e)}")
        print("\nTraceback completo:")
        traceback.print_exc()
